...
public class RectangleRunner {
    public static void main(String[] args) {
        ...
        System.out.println("Rectangle1's Area = " + rect1.calculateArea() + ", " + "Box Volume = " + rect1.calculateBoxVolume(rect1Height));
        System.out.println("Rectangle2's Area = " + rect1.calculateArea() + ", " + "Box Volume = " + rect1.calculateBoxVolume(rect2Height));
